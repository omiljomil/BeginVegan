				...
				<table>
					...
					<tr>
						<td colspan="3" class="all_order_third">
							...
							<input type="button" value="결제하기" class="all_orderBtn2" id="all_orderBtn2" onclick="paiementCheck()">
						</td>
					</tr>
				</table>
				</form>
			      ...
			      if ( rsp.success ) {
			         ...
			         jQuery.ajax({
			            ...
			            if ( everythings_fine ) {
			               ...
			               //[4] 결제된 금액이 요청한 금액과 달라 결제를 자동 취소 처리하였습니다.
			            }
			         });
			         //성공시 이동할 페이지
			        $.ajax({
			           url:'insertOrderInfo.me',
			           data:{
			        	   userId: $('#userId').val(),
