...
public class ProductService {
   ...
   public int getListCateCount(String cNo) {
      Connection conn = getConnection();
      
      int listCateCount = pDAO.getListCateCount(conn, cNo);
   ...
   public int getSearchListCount(String search) {
      ...
      int listSearchCount = pDAO.getListSearchCount(conn, search);
   ...
   public int getAllListCount() {
      ...
      int listCateCount = pDAO.getAllListCount(conn);
   ...
   public ArrayList<Product> selectPListAll(PageInfo pi) {
      Connection conn = getConnection();
      ArrayList<Product> list = new ArrayList<Product>();
