...
public class SearchProductServlet extends HttpServlet {
   ...
   protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
      ...
      //1. 전체 게시글 개수 조회   
      listSearchCount = pService.getSearchListCount(search);
      ...
      //4. 각 변수 계산식 작성
      maxPage = (int)Math.ceil((double)listSearchCount / boardLimit);
      ...
      PageInfo pi = new PageInfo(currentPage, listSearchCount, pageLimit, boardLimit, maxPage, startPage, endPage);
