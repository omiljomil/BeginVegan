...
/**
 * Servlet implementation class ProductCateListServlet
 */
@WebServlet("/ProductCateListServlet.do")
public class ProductCateListServlet extends HttpServlet {
   private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ProductCateListServlet() {
        super();
   ...
   protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
      //리스트이기 때문에 페이징처리, 썸네일 사진도 불러올 수 있게 해야함
            ...
            //1. 전체 게시글 개수 조회   
               ...
               listCateCount = pService.getListCateCount(cNo);
            ...
            if(cNo.equals("100")) {
               ...
               plist = pService.selectPList(pi, cNo);   
            }
