...
public class ChangeOrderListServlet extends HttpServlet {
   ...
   protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
      /*
       * // 페이징 처리에 필요한 변수 int listCount; int currentPage; int pageLimit; int
       * boardLimit; int maxPage; int startPage; int endPage;
       * 
       * OrderListService oService = new OrderListService(); // 페이징 처리 1단계 listCount =
       * oService.getChangeListCount();
       */
